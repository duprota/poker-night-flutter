...
void main() {
  runApp(const PokerNightDemoApp());
}

class PokerNightDemoApp extends StatelessWidget {
  const PokerNightDemoApp({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const PokerNightDemoScreen(),
    );
  }
}

class PokerNightDemoScreen extends StatefulWidget {
  const PokerNightDemoScreen({Key? key}) : super(key: key);

  @override
  State<PokerNightDemoScreen> createState() => _PokerNightDemoScreenState();
}

class _PokerNightDemoScreenState extends State<PokerNightDemoScreen> {
